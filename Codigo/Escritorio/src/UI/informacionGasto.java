...
/**
 * Método para obtener los distintos datos del usuario
 * @param usuarios Objeto usuarios con el identificador del usuario que se desea obtener los datos
 */
   ...
   /**
    * Método para obtener la imagen de perfil del usuario y cargarlo en formato icono en pantalla
    * @param usuarios 
    */
